...
function formatTime(s) {
    ...
    else if (s.lt(3600)) return formatWhole(s.div(60).floor()) + "m " + format(s.mod(60)) + "s"
    else if (s.lt(86400)) return formatWhole(s.div(3600).floor()) + "h " + formatWhole(s.div(60).floor().mod(60)) + "m " + format(s.mod(60)) + "s"
    else if (s.lt(31536000)) return formatWhole(s.div(86400).floor()) + "d " + formatWhole(s.div(3600).floor().mod(24)) + "h " + formatWhole(s.div(60).floor().mod(60)) + "m " + format(s.mod(60)) + "s"
    else if (s.lt(31536000000)) return formatWhole(Math.floor(s.div(31536000).floor())) + "y " + formatWhole(s.div(86400).floor().mod(365)) + "d " + formatWhole(s.div(3600).floor().mod(24)) + "h " + formatWhole(s.div(60).floor().mod(60)) + "m " + format(s.mod(60)) + "s"
